    ...
    <div class="conditionSummary">
      ...
      <div class="conditionSummaryList">
        <div class="tagBorder">
          ...
          <el-autocomplete class="input-new-tag" v-model="inputValue" ref="saveTagInput" size="small" @keyup.enter.native="handleInputConfirm" :fetch-suggestions="querySearch" @select="handleInputConfirm">
          </el-autocomplete>
        </div>
      </div>
    </div>
